...
lia.config.PlayerModelTposingFixer = {"models/player/Group03/female_03.mdl", "models/player/Group01/male_02.mdl", "models/player/player.mdl", "models/hlvr/characters/combine_captain/combine_captain_hlvr_player.mdl", "models/sirris/sirris_hl_fem_custom.mdl", "models/hlvr/characters/worker/worker_player.mdl", "models/hlvr/characters/worker/worker_player.mdl", "models/hlvr/characters/hazmat_worker/hazmat_worker_player.mdl", "models/nemez/combine_soldiers/combine_soldier_elite_pm.mdl", "models/nemez/combine_soldiers/combine_soldier_pm.mdl", "models/nemez/combine_soldiers/combine_soldier_shotgunner_pm.mdl", "models/nemez/combine_soldiers/combine_soldier_border_patrol_pm.mdl", "models/nemez/combine_soldiers/combine_soldier_urban_pm.mdl", "models/taggart/gallahan.mdl", "models/nemez/combine_soldiers/combine_soldier_urban_shotgunner_pm.mdl" , "models/dannio/pmcitizen/urbanmetrocop/male_merged.mdl" , "models/dannio/pmcitizen/urbanmetrocop/female_merged.mdl"}
-- Default Staff Ranks
